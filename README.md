...
├── progress.json        # Progress tracking with timestamps (auto-generated)
├── file_manifest.json   # File metadata for object storage (auto-generated)
  ...
  "files": [
    {
      ...
      "filepath": "/path/to/listings_part_001.jsonl",
